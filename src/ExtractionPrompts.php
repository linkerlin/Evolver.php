...
final class ExtractionPrompts
{
     ...
     */
    public static function buildExtractionPrompt(string $conversationText, string $user = 'User'): string
    {
        return <<<PROMPT
...
PROMPT;
    ...
    /**
     * Build dedup prompt for candidate memory.
     */
    public static function buildDedupPrompt(
        string $candidateAbstract,
...
PROMPT;
    ...
    /**
     * Build merge prompt for combining memories.
     */
    public static function buildMergePrompt(
        string $existingAbstract,
        string $existingOverview,
        ...
        return <<<PROMPT
Merge the following memory into a single coherent record with all three levels.
